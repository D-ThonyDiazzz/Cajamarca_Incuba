...
const tocConfig = [
    ...
    { title: "Puerta 2: Negocios validos con prototipo o piloto comercial",              page: 27,  level: "apartado" },
    ...
    { title: "Escalamiento: Vinculación con inversión, mercado y fnanciamiento",              page: 56,  level: "subtitulo" },
    { title: "El respaldo de la confanza: Financiamiento y fondo de garantía",              page: 56,  level: "subtitulo" },
    ...
    { title: "Lecciones y propuestas",                    page: 96,  level: "apartado" },
