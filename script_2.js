...
// ============================================================
// SECCIONES para el SELECT "Ir a sección..." del nav
// (navegación rápida por capítulos principales)
// ============================================================
...
// ============================================================
// ÍNDICE DEL SIDEBAR — 100% INDEPENDIENTE Y MANUAL
// Aquí defines cada entrada del índice con detalle.
//
// CÓMO AGREGAR ENTRADAS:
//   { title: "Nombre de la sección", page: NÚMERO_DE_PÁGINA_PDF, level: "NIVEL" }
//
// NIVELES DISPONIBLES:
//   "titulo"    → Título principal (capítulo) — negrita, borde azul
//   "subtitulo" → Subtítulo (sección dentro de un capítulo) — indentado
//   "apartado"  → Apartado menor (sub-sección) — más indentado, texto ligero
//
// EJEMPLO:
//   { title: "Capítulo 1: Historia",        page: 16, level: "titulo" },
//   { title: "Orígenes del programa",        page: 17, level: "subtitulo" },
//   { title: "Primera convocatoria",         page: 19, level: "apartado" },
// ============================================================
const tocConfig = [
...
function generateVideoList() {
    // La sección de videos del sidebar se eliminó del HTML.
    // Esta función se mantiene vacía para no romper la llamada en init().
}
